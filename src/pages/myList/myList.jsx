    ...
    <div className="bg-light-purple h-full w-full flex items-center justify-start flex-col">
      ...
      <div className="w-4/5 h-4/5 bg-white rounded-2xl drop-shadow-lg overflow-x-auto max-w-[80vw] max-h-[80vh]">
        <div className="h-full min-w-full w-max grid grid-cols-4 content-stretch ">
          <div className="min-w-[10rem] border-x-2 overflow-y-auto border-black bg-red-100  flex flex-col items-center gap-3 p-3">
            <AnimeListCard />
            <AnimeListCard />
            <AnimeListCard />
            <AnimeListCard />
          ...
          <div className="min-w-[10rem] border-x-2 border-black bg-red-100  flex flex-col items-center gap-4 p-2">
            <AnimeListCard />
            <AnimeListCard />
            <AnimeListCard />
          </div>
