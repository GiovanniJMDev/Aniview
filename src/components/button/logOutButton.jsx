const LogOutButton = ({ isExpanded, title }) => {
  return (
    <button
      className={
        "bg-raspberry-red hover:bg-dark-raspberry-red hover:border-white border-4 border-transparent rounded-3xl p-2 text-start w-fit transition-all duration-500 ease-in-out p-2"
      }
    >
      <svg
